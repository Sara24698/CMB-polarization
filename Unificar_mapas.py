...
def Smooth_FullSkyMap(in_map, out_map, in_fwhm, out_fwhm):
   ...
   mappa = hp.read_map(in_map, (0,1,2))
   #smo_map = hp.smoothing(mappa, fwhm = sigma_smo, nest = False)
   CMB_Smoothed = hp.sphtfunc.smoothing(mappa, fwhm = 0.00436332)

   

   hp.write_map(out_map+'.fits', CMB_Smoothed, nest = False )
   #hp.mollview(mappa)
   #plt.savefig(out_map+'.png')
   pass

Smooth_FullSkyMap("./Ruido_Planck_143.fits","Ruido_Planck_143_15arcmin", 433.2, 433.2)
Smooth_FullSkyMap("./CMB_143GHZ_SimPlanck.fits","CMB_143GHZ_SimPlanck_15arcmin", 433.2, 433.2)
...
#Smooth_FullSkyMap("./R_0_01/Mapa_U_143_GHz.fits","Mapa_U_143_GHz", 294.0, 433.2)
#Smooth_FullSkyMap("./R_0_004/Mapa_total_217_GHz.fits","Mapa_total_143_GHz_R_0_004", 294.0, 433.2)
#Smooth_FullSkyMap("./R_0_001/Mapa_Q_143_GHz.fits","Mapa_total_143_GHz_R_0_001", 294.0, 433.2)
